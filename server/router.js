...
const router = (app) => {
  ...
  app.post('/delete', mid.requiresLogin, controllers.Opp.deleteOpp);
  ...
  app.get('/myevents', mid.requiresLogin, controllers.Opp.myEventsPage);
  ...
  app.get('/getMyOpps', mid.requiresLogin, controllers.Opp.getOppsByOwner);
